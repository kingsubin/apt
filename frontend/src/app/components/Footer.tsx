  ...
  return (
    <footer className="bg-white text-gray-800 py-8">
      <div className="container mx-auto flex flex-col md:flex-row justify-between items-start px-4">
        ...
        <div className="flex-1 mb-4 md:mb-0">
          ...
          <ul className="space-y-2">
            <li>
              <a href="/about" className="hover:text-blue-500 text-sm">
                회사 소개
              </a>
            </li>
            <li>
              <a href="/services" className="hover:text-blue-500 text-sm">
                서비스 안내
              </a>
            </li>
            <li>
              <a href="/faq" className="hover:text-blue-500 text-sm">
                자주 묻는 질문
              </a>
            </li>
          </ul>
        ...
        <div className="flex-1 mb-4 md:mb-0">
          ...
          <ul className="space-y-2">
            <li>
              <a href="/contact" className="hover:text-blue-500 text-sm">
                고객센터
              </a>
            </li>
            <li>
              <a href="/privacy" className="hover:text-blue-500 text-sm">
                개인정보 처리방침
              </a>
            </li>
            <li>
      ...
      <div className="text-center mt-4">
        <p className="text-sm">
          &copy; {new Date().getFullYear()} Kindom. All rights reserved.
        </p>
      </div>
    </footer>
  );
